...
1. 复习感知机，如下图，
   ...
   <img src="C:/Users/Cakes/AppData/Roaming/Typora/typora-user-images/image-20211209101859411.png" alt="image-20211209101859411" style="zoom:58%;" />
...
5. 例如如下的神经网络，使用矩阵乘法，可将第一层的加权和表示成$A^{(1)}=XW^{(1)}+B^{(1)}$
   ...
   <img src="C:/Users/Cakes/AppData/Roaming/Typora/typora-user-images/image-20211209105002370.png" alt="image-20211209105002370" style="zoom:57%;" />

   其中，$w^{(1)}_{12}$表示第一层权重里前一层的第二个节点到后一层第一个节点的权重值

   <img src="C:/Users/Cakes/AppData/Roaming/Typora/typora-user-images/image-20211209105231319.png" alt="image-20211209105231319" style="zoom:58%;" />
